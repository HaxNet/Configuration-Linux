...
export ZSH="/home/haxnet/.oh-my-zsh"
...
alias ytmp3='youtube-dl --extract-audio --audio-format mp3 --audio-quality 0 --embed-thumbnail --prefer-ffmpeg --youtube-skip-dash-manifest --ignore-errors --restrict-filenames --verbose $f'

alias cclear='clear && cd'
alias syu='sudo pacman -Syu | lolcat'
alias neo='neofetch'
...
zstyle :compinstall filename '/home/haxnet/.zshrc'
