# Generated by Powerlevel10k configuration wizard on 2021-02-13 at 20:50 EST.
# Based on romkatv/powerlevel10k/config/p10k-lean.zsh, checksum 43896.
# Wizard options: powerline, unicode, lean, 12h time, 1 line, sparse, concise,
...
() {
  ...
  typeset -g POWERLEVEL9K_VPN_IP_INTERFACE='(wgpia|gpd|wg|(.*tun)|tailscale)[0-9]*'
